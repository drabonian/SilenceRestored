...
function carRide()
	...
	while true do
		...
		print(v27.Name .. "'s Position: ( " .. v27.Position.X .. ", " .. v27.Position.Y .. ", " .. v27.Position.Z .. " )");
		if v26 == 5 then
			print("Reached 5...")
			spawnFlashBack();
		elseif v26 == 6 then
			...
			coroutine.resume(coroutine.create(function()
				...
				player.Character.Torso.CFrame = CFrame.new(-865.3, 28.1, -1170.3) * CFrame.Angles(0, 1.5707963267948966, 0);
				wait(0.06);
		...
		elseif v26 == 13 then
			...
			gameGui.LocalScript.LocalCanSwitch.Value = false;
		...
		while true do
			...
			local v48 = v47 * (Vector3.new(v27.Position.x, v27.Position.y + v24, v27.Position.z) - v20.Base.Position).unit;
			...
			if v26 < 30 then
				v20.CarHUD.SurfaceGui.Text1.Text = ":" .. math.ceil((v20.Base.Position - level.CarPath.CarPath30.Position).magnitude + 8);
			else
				v20.CarHUD.SurfaceGui.Text1.Text = ":0";
			end;
			wait(0.12);
			if not ((v20.Base.Position - Vector3.new(v27.Position.x, v20.Base.Position.y, v27.Position.z)).magnitude < 4) then
...
function runObjectives()
	...
	if stat.LoadingZone.Value == 1 then
...
function event1()
	...
	for i = 1, #v68 do
		...
		tweenFrame(frame.c1.Value, frame.f1.Value, frame.step.Value, frame.FOV.Value, frame.Roll.Value, frame.Style.Value);
	end;
	(function()
	...
	(function()
		...
		local v78 = { "http://www.roblox.com/asset/?id=140359949", "http://www.roblox.com/asset/?id=140359931", "http://www.roblox.com/asset/?id=140359907" };
