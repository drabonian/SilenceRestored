...
local v8 = require(workspace.CFrameInterpolator);
local debrisService = game:GetService("Debris");
local legs = { char:findFirstChild("Left Leg"), char:findFirstChild("Right Leg") };
...
local v14 = CFrame.new(0.5, 0.6, 0.8) * CFrame.Angles(1.6580627893946132, 0, 0);
local v15 = CFrame.new(-0.5, 0.4, 0.3) * CFrame.Angles(-0.2617993877991494, 0, 0);
...
v19.Touched:connect(function(p1)
	if u3 and p1 and p1.Parent then
		if not statFolder.Mode.Value then
			...
			normalDamage(p1, tools[statFolder.Tool.Value].damage, statFolder.Tool.Value);
		end;
		u3 = false;
	end;
end);
	...
	while true do
		...
		while true do
			...
			while true do
				...
				v52.CFrame = CFrame.new(l__X__38 - (l__X__41 - 1) / 2 + v47, l__Y__39 - (l__Y__42 - 1) / 2 + v49, l__Z__40 - (l__Z__43 - 1) / 2 + v51) * v44;
				debrisService:AddItem(v52, 0.5);
				v52.Parent = camera;
				if 0 <= 1 then
					if v51 < v50 then
...
function normalThrow()
	...
	u13 = 4;
	local v63, v64 = v8(u7, u9);
	local v65, v66 = v8(u10, u12);
	local v67 = 1 - 1;
	while true do
		u8 = v64(v67 / u13);
		u11 = v66(v67 / u13);
...
function normalZoom(p19, p20, p21, p22)
	...
	local v74, v75 = v8(u21, p19);
	local v76, v77 = v8(u22, p20);
	local v78, v79 = v8(p21, p22);
	local v80 = 1 - 1;
	while true do
	...
	if u5 then
		if u16 then
			local v81, v82 = v8(p19, u21);
			local v83, v84 = v8(p20, u22);
			local v85, v86 = v8(p22, p21);
			local v87 = 1 - 1;
			while true do
				camera.FieldOfView = camera.FieldOfView + 5;
				u14.C1 = v86(v87 / 4);
...
function onFireNormal(p28, p29, p30)
	...
	if p28 then
		v93 = (CFrame.new(Vector3.new(0, 0, 0), v92) * CFrame.Angles(0, 0, math.random() * 2 * math.pi) * CFrame.Angles(math.random() * u24 / 2, 0, 0)).lookVector;
	else
		v93 = (CFrame.new(Vector3.new(0, 0, 0), v92) * CFrame.Angles(0, 0, math.random() * 2 * math.pi) * CFrame.Angles(math.random() * u24, 0, 0)).lookVector;
	end;
	...
	if v95 then
		...
		v99.Parent = v97;
		v97.Parent = camera;
		debrisService:AddItem(v97, 0.06);
	end;
	if v94 then
		if v94.Parent then
			if v95 then
...
function fists(p31)
	if p31 == 1 then
		if not u25[2] then
			...
			while true do
				...
				u7 = u21;
				u9 = CFrame.new(1.6, 1.2, 0.55) * CFrame.Angles(-1.9198621771937625, 0.6981317007977318, 0.2617993877991494);
				u10 = u22;
				...
				u13 = 6;
				local v100, v101 = v8(u7, u9);
				local v102, v103 = v8(u10, u12);
				local v104 = 1 - 1;
				while true do
					u8 = v101(v104 / u13);
					u11 = v103(v104 / u13);
				...
				waitTime(1);
				u13 = 8;
				local v105, v106 = v8(u9, u7);
				local v107, v108 = v8(u12, u10);
				local v109 = 1 - 1;
				while true do
					u8 = v106(v109 / u13);
					u11 = v108(v109 / u13);
	...
	while true do
		...
		v20.C1 = v20.C1 + Vector3.new(0, 1, 0);
		u13 = 6;
		local v110, v111 = v8(u7, u9);
		local v112, v113 = v8(u10, u12);
		local v114 = 1 - 1;
		while true do
			u8 = v111(v114 / u13);
			u11 = v113(v114 / u13);
		...
		waitTime(1);
		u13 = 8;
		local v115, v116 = v8(u9, u7);
		local v117, v118 = v8(u12, u10);
		local v119 = 1 - 1;
		while true do
			u8 = v116(v119 / u13);
			u11 = v118(v119 / u13);
	...
	if p32 == 1 then
		while true do
			...
			if 0 < statFolder.Ammo.Value then
				...
				u13 = 6;
				local v120, v121 = v8(u7, u9);
				local v122, v123 = v8(u10, u12);
				local v124 = 1 - 1;
				while true do
					u8 = v121(v124 / u13);
					u11 = v123(v124 / u13);
				...
				waitTime(1);
				u13 = 5;
				local v125, v126 = v8(u12, CFrame.new(-1.32, 0.07, -0.46) * CFrame.Angles(0.22, -0.39, -0.032));
				local v127 = 1 - 1;
				while true do
					u11 = v126(v127 / u13);
					waitTime(1);
				...
				waitTime(1);
				u13 = 6;
				local v128, v129 = v8(u9, u7);
				local v130, v131 = v8(CFrame.new(-1.32, 0.07, -0.46) * CFrame.Angles(0.22, -0.39, -0.032), u10);
				local v132 = 1 - 1;
				while true do
					u8 = v129(v132 / u13);
					u11 = v131(v132 / u13);
		...
		while true do
			...
			if 0 < statFolder.Ammo.Value then
				...
				v20.C1 = v20.C1 + Vector3.new(0, 1, 1);
				u13 = 6;
				local v133, v134 = v8(u7, u9);
				local v135, v136 = v8(u10, u12);
				local v137 = 1 - 1;
				while true do
					u8 = v134(v137 / u13);
					u11 = v136(v137 / u13);
				...
				waitTime(1);
				u13 = 8;
				local v138, v139 = v8(u9, u7);
				local v140, v141 = v8(u12, u10);
				local v142 = 1 - 1;
				while true do
					u8 = v139(v142 / u13);
					u11 = v141(v142 / u13);
...
function pistol(p34)
	...
	if p34 == 1 then
		if 0 < statFolder.Ammo.Value then
			reduceAmmo();
			local v143 = tools[statFolder.Tool.Value].recoil / 2;
			if isSprinting then
				v143 = v143 + 0.004;
			elseif sliding then
				v143 = v143 - 0.003;
			...
			onFireNormal(not u25[2], tools[statFolder.Tool.Value].damage, tools[statFolder.Tool.Value].range);
			u30 = tools[statFolder.Tool.Value].recoil;
			u31 = math.random(-1, 1) * 0.01;
			camera.CoordinateFrame = CFrame.new(camera.Focus.p) * (camera.CoordinateFrame - camera.CoordinateFrame.p) * CFrame.Angles(u30, u31, 0) * CFrame.new(0, 0, (camera.CoordinateFrame.p - camera.Focus.p).magnitude);
		...
		normalZoom(CFrame.new(1.2, 0.2, 0.65) * CFrame.Angles(-1.5707963267948966, 0.7853981633974483, 0), CFrame.new(-1.2, 0.2, 0.66) * CFrame.Angles(-1.5707963267948966, -0.7853981633974483, 0), u14.C1, CFrame.new(0.72, -0.32, 1) * CFrame.Angles(1.6057029118347832, 0, -0.7853981633974483));
	end;
	u25[p34] = true;
end;
function machinePistol(p35)
	if p35 == 1 then
		...
		u25[2] = false;
		normalZoom(CFrame.new(1.2, 0.2, 0.65) * CFrame.Angles(-1.5707963267948966, 0.7853981633974483, 0), CFrame.new(-1.2, 0.2, 0.66) * CFrame.Angles(-1.5707963267948966, -0.7853981633974483, 0), u14.C1, CFrame.new(0.7, -1, 0) * CFrame.Angles(3.1764992386296798, 0, -0.7853981633974483));
		u25[2] = true;
		return;
	end;
	u25[1] = false;
	while true do
		...
		if 0 < statFolder.Ammo.Value then
			reduceAmmo();
			local v144 = tools[statFolder.Tool.Value].recoil / 2;
			if isSprinting then
				v144 = v144 + 0.004;
			elseif sliding then
				v144 = v144 - 0.003;
...
function assaultRifle(p36)
	if p36 == 1 then
		...
		u25[2] = false;
		normalZoom(CFrame.new(1.03, -0.1, 0.51) * CFrame.Angles(-1.45, 0.78, -0.09), CFrame.new(-1.03, -0.09, 0.51) * CFrame.Angles(-1.45, -0.78, 0.09), u14.C1, CFrame.new(-0.24, 1.56, 0.81) * CFrame.Angles(-1.57, -1.48, -2.36));
		u25[2] = true;
		return;
	end;
	...
	while true do
		...
		if 0 < statFolder.Ammo.Value then
			reduceAmmo();
			local v145 = tools[statFolder.Tool.Value].recoil / 2;
			if isSprinting then
				v145 = v145 + 0.004;
			elseif sliding then
				v145 = v145 - 0.003;
...
function revolver(p37)
	if p37 == 1 then
		...
		u25[2] = false;
		normalZoom(CFrame.new(0.84, -0.1, -1.24) * CFrame.Angles(-2.57, -0.07, 1.42), CFrame.new(-1.2, 0.2, 0.66) * CFrame.Angles(-1.5707963267948966, -0.7853981633974483, 0), u14.C1, CFrame.new(0.7, -1, -0.2) * CFrame.Angles(3.1764992386296798, 0, -0.7853981633974483));
		u25[2] = true;
		return;
	end;
	u25[1] = false;
	if 0 < statFolder.Ammo.Value then
		reduceAmmo();
		local v146 = tools[statFolder.Tool.Value].recoil / 2;
		if isSprinting then
			v146 = v146 + 0.004;
		elseif sliding then
			v146 = v146 - 0.003;
...
function shotgun(p38)
	if p38 == 1 then
		...
		u25[2] = false;
		normalZoom(CFrame.new(-0.099, 1.511, 1.418) * CFrame.Angles(-0.998, 0.278, -1.81), CFrame.new(-0.829, -0.263, 0.734) * CFrame.Angles(-1.408, -0.883, 0.301), u14.C1, CFrame.new(0.834, -0.256, 1.449) * CFrame.Angles(1.466, -0.174, -0.908));
		u25[2] = true;
		return;
	end;
	u25[1] = false;
	if 0 < statFolder.Ammo.Value then
		reduceAmmo();
		local v147 = tools[statFolder.Tool.Value].recoil / 2;
		if isSprinting then
			v147 = v147 + 0.004;
		elseif sliding then
			v147 = v147 - 0.003;
		...
		local v148 = 1 - 1;
		while true do
			onFireNormal(false, tools[statFolder.Tool.Value].damage, tools[statFolder.Tool.Value].range);
			if 0 <= 1 then
				if v148 < 5 then
...
function chaingun(p39)
	if p39 == 1 then
		...
		u25[2] = false;
		normalZoom(CFrame.new(0.43, 0.3, 0.84) * CFrame.Angles(-0.54, 0.14, -0.86), CFrame.new(-1.39, 0.16, 0.34) * CFrame.Angles(-0.88, -0.13, -0.02), u14.C1, CFrame.new(0.29, 1.08, 1.04) * CFrame.Angles(0.57, -0.15, -0.08));
		u25[2] = true;
		return;
	end;
	u25[1] = false;
	while true do
		...
		if 0 < statFolder.Ammo.Value then
			reduceAmmo();
			local v151 = tools[statFolder.Tool.Value].recoil / 2;
			if isSprinting then
				v151 = v151 + 0.004;
			elseif sliding then
				v151 = v151 - 0.003;
...
function turret(p40)
	...
	if p40 == 1 then
		while true do
			...
			if 0 < statFolder.Ammo.Value then
				reduceAmmo();
				local v152 = tools[statFolder.Tool.Value].recoil / 2;
				if isSprinting then
					v152 = v152 + 0.004;
				elseif sliding then
					v152 = v152 - 0.003;
...
function runTool(p41)
	if u27 then
		if p41 ~= 1 then
			if tools[statFolder.Tool.Value].type ~= "Melee" then
				if not statFolder.Mode.Value then
					return;
				end;
			else
			...
			if statFolder.Mode.Value then
				if (head.Position - obj.Position).magnitude < 6 then
					if 0 < obj.Parent.MainPart.Amount.Value then
						if statFolder.Ammo.Value < tools[statFolder.Tool.Value].ammo * statFolder.AmmoBonus.Value * (statFolder.Difficulty.Value * 0.5) then
							local v156 = tools[statFolder.Tool.Value].ammo * statFolder.AmmoBonus.Value * (statFolder.Difficulty.Value * 0.5) - statFolder.Ammo.Value;
							if v156 <= obj.Parent.MainPart.Amount.Value then
								obj.Parent.MainPart.Amount.Value = obj.Parent.MainPart.Amount.Value - v156;
								statFolder.Ammo.Value = tools[statFolder.Tool.Value].ammo * statFolder.AmmoBonus.Value * (statFolder.Difficulty.Value * 0.5);
							else
		...
		if targetModel.Name ~= "UnlockedSlidingDoor" then
			if targetModel.Name == "UnlockedVent" then
				if targetModel.Closed.Value then
					...
					local v159 = 1 - 1;
					while true do
						targetModel.UnlockedSlidingDoor.CFrame = obj.CFrame - (obj.Parent.ClosedPosition.Position - obj.Parent.OpenPosition.Position) / 12;
						waitTime(1);
						if 0 <= 1 then
							if v159 < 12 then
			...
			elseif targetModel.Name == "UnlockedDoubleDoor" then
				if targetModel.Closed.Value then
					...
					local v161 = 1 - 1;
					while true do
						targetModel.UnlockedSlidingDoor1.CFrame = targetModel.UnlockedSlidingDoor1.CFrame - (targetModel.ClosedPosition1.Position - targetModel.OpenPosition1.Position) / 12;
						targetModel.UnlockedSlidingDoor2.CFrame = targetModel.UnlockedSlidingDoor2.CFrame - (targetModel.ClosedPosition2.Position - targetModel.OpenPosition2.Position) / 12;
						waitTime(1);
						if 0 <= 1 then
							if v161 < 12 then
...
UserInputService.InputBegan:Connect(function(input, gpe)
	...
	if script.LocalPause.Value then return end
...
humanoid.Jumping:connect(function()
	...
	v167.D = 250;
	v167.P = 2000;
	v167.position = Vector3.new(torso.Position.x + l__unit__166.x * (v165 / 3), torso.Position.y + v165 - 7, torso.Position.z + l__unit__166.z * (v165 / 3));
	v167.Parent = torso;
	waitTime(7);
	v167:Destroy();
end);
...
function getCurrentTool()
	...
	if not u6 then
		...
		u13 = 6;
		local v177, v178 = v8(u7, u9);
		local v179, v180 = v8(u10, u12);
		local v181 = 1 - 1;
		while true do
			u8 = v178(v181 / u13);
			u11 = v180(v181 / u13);
	...
	if statFolder.Mode.Value then
		if statFolder.Tool.Value ~= "None" then
			u20 = tools[statFolder.Tool.Value].reticle;
			statFolder.Spread.Value = tools[statFolder.Tool.Value].spread;
			...
			u21 = tools[statFolder.Tool.Value].weldLA;
			u22 = tools[statFolder.Tool.Value].weldRA;
			u8 = u21;
			u11 = u22;
			...
			u14.Parent = arms[2];
			u14.Part1 = u16;
			u14.C1 = tools[statFolder.Tool.Value].weldTool;
			u16.Parent = v18;
			playSoundEffect("SwitchWeapon", u16);
			u7 = u8;
			u10 = u11;
			u13 = 6;
			local v182, v183 = v8(u9, u7);
			local v184, v185 = v8(u12, u10);
			local v186 = 1 - 1;
			while true do
				u8 = v183(v186 / u13);
				u11 = v185(v186 / u13);
			...
			if not u6 then
				...
				u10 = u11;
				u13 = 6;
				local v187, v188 = v8(u9, u7);
				local v189, v190 = v8(u12, u10);
				local v191 = 1 - 1;
				while true do
					u8 = v188(v191 / u13);
					u11 = v190(v191 / u13);
		...
		if not u6 then
			...
			u10 = u11;
			u13 = 6;
			local v192, v193 = v8(u9, u7);
			local v194, v195 = v8(u12, u10);
			local v196 = 1 - 1;
			while true do
				u8 = v193(v196 / u13);
				u11 = v195(v196 / u13);
...
function mouseTarget()
	...
	if target then
		if target.Parent then
			...
			l__TouchedInfo__37.Visible = false;
			local v201 = target.Parent:findFirstChild("Humanoid") or (target.Parent.Parent:findFirstChild("Humanoid") or target.Parent.Parent.Parent:findFirstChild("Humanoid"));
			u27 = false;
			if v201 then
					...
					if 0 < v201.Health then
						if v201.Parent:findFirstChild("Head") then
							if not v201.Parent:findFirstChild("ForceField") then
								if statFolder.Tool.Value ~= "None" then
									if (mouse.Hit.p - u16.Position).magnitude <= tools[statFolder.Tool.Value].range then
			...
			if (head.Position - target.Position).magnitude < 32 then
				...
				if (head.Position - target.Position).magnitude < 6 then
					...
					if target.Parent.Name == "Ammo" then
						...
						elseif statFolder.Ammo.Value == tools[statFolder.Tool.Value].ammo * statFolder.AmmoBonus.Value * (statFolder.Difficulty.Value * 0.5) then
	...
	if gameGui.HurtOverlay.Size.X.Scale + 0.01 < 3 then
		if gameGui.HurtOverlay.Size.Y.Scale + 0.01 < 2 then
			if not u57 then
				...
				gameGui.HurtOverlay:TweenSizeAndPosition(UDim2.new(1 + 2 * v215, 0, 1 + 1 * v215, 0), UDim2.new(0 - 1 * v215, 0, 0 - 0.5 * v215, 0), "Out", "Quad", 6 - 4 * v215, true);
			end;
		end;
	end;
